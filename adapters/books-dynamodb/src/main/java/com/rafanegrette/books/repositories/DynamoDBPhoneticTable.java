...
@Service("DynamoDBPhoneticTable")
public class DynamoDBPhoneticTable implements DBBookTable {

    private final DynamoDbTable<BookDyna> bookTable;

    public DynamoDBPhoneticTable(@Qualifier("DynamoBookPhonetic") DynamoDbTable<BookDyna> bookTable) {
